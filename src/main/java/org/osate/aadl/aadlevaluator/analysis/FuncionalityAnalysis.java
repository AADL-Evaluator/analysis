...
public class FuncionalityAnalysis extends Analysis<Map<String,Property>>
{
    ...
    public FuncionalityAnalysis( final String charact , final String sub , final String name , final String title , final Map<String,Property> A , final Map<String,Property> B )
    {
